...
import { IfcClient } from "./baseClient";
...
import { EnvData, KeyData } from "./messages/Lifecycle";
...
export class Client extends IfcClient<Window> {
  ...
  protected _postMessage(message: ClientToHost): void {
    this._globalContext.parent.postMessage(message, {
      targetOrigin: this._hostOrigin,
    });
  }
